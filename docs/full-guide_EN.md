...
> It is Issue #1497 scope clarification only; runtime trigger-control behavior is unchanged and this change must not be used to auto-close Issue #1497 (it remains a follow-up runtime implementation task).
...
> This note is for scope clarification only; runtime trigger-control implementation is planned in a follow-up PR.
